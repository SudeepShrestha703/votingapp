Here is a two seperate project with one API project as Voting made in .net core with CQRS pattern and a Voting-UI made in angular 17 with standalone feature in Facade pattern.
